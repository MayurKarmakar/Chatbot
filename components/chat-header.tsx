...
function ChatHeader({ handleResetError }: ChatHeaderProps) {
  ...
  return (
    <div className="flex flex-row w-full h-auto items-center justify-between border-b-2 border-[#3c3e42] px-5 dark:text-gray-300 text-lg py-3 gap-5">
      <p className="text-[18px] font-[700] leading-[1.33334] tracking-normal">
        Chatbot
      </p>
      <button
        onClick={handleNewSession}
        className="ml-auto text-sm bg-gray-700 border-gray-700 hover:bg-gray-600 rounded-md px-3 dark:text-white p-2"
      >
        New Session
      </button>
